...
//! Question: How do you declare JS functions?
...
//? The code that might throw an error is put inside a try block, and the catch block is used to handle the error. The catch block takes an error object as an argument, which provides information about the error that was thrown.
...
//* Answer: null is a value that represents the intentional absence of any object value. undefined is a value that indicates that a variable has been declared but has not been assigned a value.
